// CAFR allocation classifier prompt (v1.0-cafr).
//
...
export const CAFR_PROMPT_VERSION = "v1.0-cafr";
...
**Standardized asset class enum (roll sub-categories up to the parent):**
...
- **Sub-category stand-alone rows.** If a table shows "Buyout 8%", "Growth 3%", "Secondaries 2%" without a "Private Equity 13%" roll-up, emit one PE row with target_pct=13.0 summing the sub-rows. Do NOT emit three rows.
- **Sector / geography breakdowns within an asset class.** "US PE 60% / Non-US PE 40%" inside PE is style, not policy allocation. Skip.
